...
| **[FLEx XML Viewer](https://github.com/rulingAnts/flexml_viewer)** | `rulingAnts/flexml_display` | A client-side web app for viewing, exploring, and exporting FieldWorks (FLEx) XML exports (Lists, Phonology, Wordforms) in a structured, readable format. **Runs entirely in your browser.** | HTML/JavaScript, XSLT |
